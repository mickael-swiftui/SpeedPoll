...
class MessagesViewController: MSMessagesAppViewController {
    ...
    var hostingController: UIHostingController<MessagesView>?
    ...
    private func setupView() {
        // 1: Instancier la vue
        let messagesView = MessagesView(delegate: self)
        
        // 2: Initialiser le hosting controller
        hostingController = UIHostingController(rootView: messagesView)
        
        // 3: Assurez-vous que le contrôleur d'hébergement a une taille et un emplacement appropriés
        if let hostingView = hostingController?.view {
            hostingView.translatesAutoresizingMaskIntoConstraints = false
            self.view.addSubview(hostingView)
            
            // Contraintes pour que la vue SwiftUI remplisse le MSMessagesAppViewController
        ...
        // Ajoutez le UIHostingController comme un enfant ViewController
